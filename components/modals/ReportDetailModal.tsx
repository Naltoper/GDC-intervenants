          ...
          >
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <DetailRow
                ...
                value={report.lieu ?? undefined}
              />
              <DetailRow
                styles={styles}
                label="Date / Période"
                value={report.date_faits ?? undefined}
              />
              <DetailRow
                styles={styles}
                label="Fréquence"
                value={report.frequence ?? undefined}
              />
              <DetailRow
                styles={styles}
                label="Victimes"
                value={report.nb_victimes ?? undefined}
              />
...
const DetailRow = ({
  ...
  <View style={styles.detailRow}>
    ...
    <Text style={[styles.detailValue, color ? { color } : null]}>{value || 'Non précisé'}</Text>
  </View>
);
