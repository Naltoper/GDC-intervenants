...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, 
  Dimensions, Image, Platform, Linking } from 'react-native';
...
const InstallBanner = () => {
  ...
  const apkUrl = "https://github.com/Naltoper/GDC-intervenants/releases/download/v1.0.0/GDC-Intervenants.apk"; // Lien vers apk
...
export default function HomeScreen() {
  ...
  const menuButtons = [
    { 
        ...
        route: "/(tabs)/login", // TODO route vers login
